//****************************************************************************
// @Module        Trans_Protocol allocation
// @Filename      Trans_Protocol.H
// @Project       XC2000_EV
//----------------------------------------------------------------------------
...
#define OBD_ReqCurrDiagData_15031                      0x01
#define OBD_ReqFreezeFrame_15031                       0x02
#define OBD_ReqConfirmDTC_15031                        0x03
#define OBD_ReqClearInf_15031                          0x04
#define OBD_ReqPendingDTC_15031                        0x07
#define OBD_ReqVehInf_15031                            0x09
#define OBD_ReqPermanentDTC_15031                      0x0A
...
#define  OBDII_TP_valSendBS     0x00
...
extern void OBDII_CmdHandler_Rec(ubyte *cmd,ubyte OBDII_lRecDataLength_LO);
extern void OBDII_Neg_Response(void);
extern void OBDII_SendControlFrame(void);
extern void OBDII_Send_ResPonsReqdata(void);
extern void OBDII_Send_ResPonsCondata(void);
