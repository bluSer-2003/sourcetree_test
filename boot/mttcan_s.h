...
{
  0x7F0, 0,             /* mask: 11 bits of ID are the target bus */
  0x340,                 /* the ID is relevant here,0x11 */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x360,                 /* the ID is relevant here,0x15 */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x380,                 /* the ID is relevant here,0x18 */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x3E0,                 /* the ID is relevant here,0x19 */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x220,                 /* the ID is relevant here,0x1A */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x240,                 /* the ID is relevant here,0x1C */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x280,                 /* the ID is relevant here ,0x1D*/
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x2A0,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_flash1 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x020,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_flash2 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x040,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_flash3 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x060,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_flash4 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x080,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_test8 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x1AE,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_test9 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x1E0,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_test10 =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x0A0,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
...
const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_newcan1 =
{
  0x7FF, 0,             /*  mask: 11 bits of ID are the target bus */
  0x321,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_newcan2 =
{
  0x7FF, 0,             /*  mask: 11 bits of ID are the target bus */
  0x607,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_newcan3 =
{
  0x7FF, 0,             /*  mask: 11 bits of ID are the target bus */
  0x7EB,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_newcan4 =
{
  0x7FF, 0,             /*  mask: 11 bits of ID are the target bus */
  0x307,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_newcan5 =
{
  0x7FF, 0,             /*  mask: 11 bits of ID are the target bus */
  0x7E3,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_newcan6 =
{
  0x7FF, 0,             /*  mask: 11 bits of ID are the target bus */
  0x7DF,                 /* the ID is relevant here,0x1E */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};

const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_vdc_feedback =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x3A0,                 /* 母线电压反馈帧ID */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
...
const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_current_feedback =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x3C0,                 /* 三相电流反馈帧ID */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
...
const struct ee_mttcan_filter_std MTTCAN_A_FILTER_EXAMPLE_temp_feedback =
{
  0x7F0, 0,             /*  mask: 11 bits of ID are the target bus */
  0x3F0,                 /* 温度反馈帧ID (更新为0x3F0避免与控制模式响应冲突) */
  MTTCAN_FILTER_STORE_FIFO0,                              /* store in RX FIFO 0 */
  MTTCAN_FILTERTYPE_CLASSIC               /* use ID and mask to set this filter */
};
