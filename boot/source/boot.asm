...
;-----------------------------------------------------------------------------
	...
	.align	16
	syncp
	jr32	_R_ADCA0_Group0_interrupt  ; INT0(priority0)

	.align	16
	syncp
	jr32	_r_csih0_interrupt_receive; INT0(priority1)
	...
	.align	16
	syncp
	jr32	_INTGTM_ATOM0_7 ; INT1(priority15)

	.section "EIINTTBL", const
	.align	512
	.offset (80*4)
	.dw	#_R_ADCA0_error_interrupt
	;.offset (81*4)
	;.dw	#_R_ADCA0_Group0_interrupt	
	
	;.offset (0x5B*4)
	;.dw	#_r_csih0_interrupt_receive ; INT0
	
	.offset (145*4)
	.dw	#_INTGTM_TIM1_1 ; INT1
	;.offset (159*4)
	;.dw	#_INTGTM_ATOM0_7 ; INT1
	;.rept	512 - 159
