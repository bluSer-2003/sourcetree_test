...
/***********************************************************************************************************************
* Function Name: r_csih2_callback_receiveend
...
static void r_csih2_callback_receiveend(void)
{
	...
	uint16_slave[CSI_RECEPTION_FLAG][0] = CSI_RECEIVE_OK;
    /* End user code. Do not edit comment generated here */
}
/***********************************************************************************************************************
...
* Return Value : None
***********************************************************************************************************************/
#pragma interrupt r_csih2_interrupt_receive(enable=false, channel=88, fpu=true, callt=false)
...
* Return Value : None
***********************************************************************************************************************/
#pragma interrupt r_Config_csih2_interrupt_send(enable=false, channel=87, fpu=true, callt=false)
