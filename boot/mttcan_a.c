...
void CAN_Init(void)
{
  ...
  MTTCAN_Status_bit &= MTTCAN_SetStdFilterEntry( Unit1_u08,
					      0,
                                             FilterEntry8  );	// configure P2_7 and P2_8 as port output for test
	PMSR2	= 0x01800000;
	...
	//PM4		= PM4   & ~0x0001;				// clear PM4_0 for output
...
void Exsend( exCAN_MSG *pCANMsg,u08 Unit1_u08)
{
...
//	 u32 TimeoutLimit_u32 = 100000L;
  ...
  for( DataCounter_u08 = 0;
       ...
       DataCounter_u08++ )
  {
    SendMessage.d.b[ DataCounter_u08 ] = pCANMsg->data[ DataCounter_u08 ];
  }
