...
void Routine_Control_Process(void)//31
{
	...
	{
		OBD_stRequestResult=FALSE;
		if((OBDII_TP_stEffService.TP_valRecBuf_MP[0]==0x01)||(OBDII_TP_stEffService.TP_valRecBuf_MP[0]==0x02)||(OBDII_TP_stEffService.TP_valRecBuf_MP[0]==0x03))
		{
		  	OBD_stRequestResult=TRUE;
		}
		else
	...
	if(OBD_stRequestResult==TRUE)
	{
	    	...
	    	{
	      		if(OBDII_VauRcRecor.OBDII_stExcRcSession==UDS_stDiagSeon)//(OBDII_VauRcRecor.OBDII_numRecordRC_Mp==RoutCtr_j)&&
	        	{
		          	OBDII_VauRcRecor.OBDII_stExcReturnValue=OBDII_CallBack_RoutineCtl_Execute(RoutCtr_j,OBDII_TP_stEffService.TP_valRecBuf_MP[0],&OBD_stExeReturnValue[0]);
...
void Config_TimeParameter(uword P2Server_LO,uword P2_Server_LO,uword SessionTime_LO,uword TesterPresentTime_LO)
{
