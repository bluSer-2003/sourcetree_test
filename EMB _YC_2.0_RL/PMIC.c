...
void R_Config_CSIH2_Create(void)
{
    ...
    /* Synchronization processing */
     /* Set CSIH1SCO pin */
    PIBC4 &= _PORT_CLEAR_BIT11;
    PBDC4 &= _PORT_CLEAR_BIT11;
    PM4 &= _PORT_CLEAR_BIT11;
    PFC4 &= _PORT_CLEAR_BIT11;
    PFCE4 |= _PORT_SET_BIT11;
    PMC4 |= _PORT_SET_BIT11;
    /* Set CSIH1SO pin */
...
void PMIC_Config(void)
{
	...
	//uint16_master[CSI_TRANSMISSION][2] = 0xAA50;
	//R_CSIH2_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][2], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][2]);
	//uint16_master[CSI_TRANSMISSION][2] = 0xADAF;
	//R_CSIH2_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][2], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][2]);
	...
	//uint16_master[CSI_TRANSMISSION][2] = 0xAA55;
	//R_CSIH2_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][2], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][2]);
	...
	/*
	uint16_master[CSI_TRANSMISSION][1] = 0xAA56;
	R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][1], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][1]);
	
	
	uint16_master[CSI_TRANSMISSION][1] = 0xADA8;
	R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][1], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][1]);
	...
	uint16_master[CSI_TRANSMISSION][2] = 0x4E00;
	R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][2], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][2]);
	uint16_master[CSI_TRANSMISSION][2] = 0x4E00;
	R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][2], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][2]);
	uint16_master[CSI_TRANSMISSION][2] = 0x4E00;
	R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][2], CSI_DATA_MAX, _CSIH_SELECT_CHIP_1,(uint16_t*)&uint16_master[CSI_RECEPTION][2]);
