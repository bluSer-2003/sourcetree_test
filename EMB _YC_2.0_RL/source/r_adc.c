...
void R_ADC_Init(void)
{
   ...
   // ADCF0.ADSYNSTCR = 1;
    ...
    /* 2 Bind Vr/Hw Channel */
    R_ADC_VRChannel_Bind(0, 0, 6|Pull_upDown_disable);
    R_ADC_VRChannel_Bind(0, 1, 5|Pull_upDown_disable);
    R_ADC_VRChannel_Bind(0, 2, 4|Pull_upDown_disable);
    ...
    R_ADC_VRChannel_Bind(1, 0, 6|Pull_upDown_disable);
    R_ADC_VRChannel_Bind(1, 1, 7|Pull_upDown_disable);
    R_ADC_VRChannel_Bind(1, 6, 5|Pull_upDown_disable);
...
void R_Drv_ADC_UpdateValue(uint8 Pu1ADC, uint8 Pu1SGNum)
{
    ...
    case 0:
	    ...
	    Gu1ReadAdcValue[9] = (uint16)Lu4ADC_DR2>>3;
