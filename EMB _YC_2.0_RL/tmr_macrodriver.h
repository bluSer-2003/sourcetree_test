...
#define _INT_REQUEST_OCCUR_MASK             (0x1U<<12)  /* No interrupt request is made */
...
#define _INT_PROCESSING_MASK                     (0x1U<<7)  /* Disables interrupt processing */
...
#define _INT_TABLE_VECTOR_MASK              (0x1U<<6)  /* Table reference */
