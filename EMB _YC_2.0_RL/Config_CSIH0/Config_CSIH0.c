...
void R_Config_CSIH0_Create(void)
{
    ...
    PM5 |= _PORT_SET_BIT7;  
    PMC5 &= _PORT_CLEAR_BIT7;
    PFC5 |= _PORT_SET_BIT7;
    PFCE5 &= _PORT_CLEAR_BIT7;
    PMC5 |= _PORT_SET_BIT7; 
    /* Set CSIH2CSS0 pin */
...
void A4911_Config(void)
{
	...
	uint16_master[CSI_TRANSMISSION][0] = 0x3D60;
	...
	//uint16_master[CSI_TRANSMISSION][5] = 0x0FDF;
	//R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][5], CSI_DATA_MAX, _CSIH_SELECT_CHIP_0,(uint16_t*)&uint16_master[CSI_RECEPTION][5]);
	//uint16_master[CSI_TRANSMISSION][6] = 0x0BDE;
	//R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][6], CSI_DATA_MAX, _CSIH_SELECT_CHIP_0,(uint16_t*)&uint16_master[CSI_RECEPTION][6]);
	uint16_master[CSI_TRANSMISSION][6] = 0xD77F;
	R_CSIH0_Master_Send((uint16_t*)&uint16_master[CSI_TRANSMISSION][6], CSI_DATA_MAX, _CSIH_SELECT_CHIP_0,(uint16_t*)&uint16_master[CSI_RECEPTION][6]);
